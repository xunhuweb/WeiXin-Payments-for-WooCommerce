...
class xh_weixinpay_for_wc_core extends WC_Payment_Gateway
{
    ...
    function WX_enqueue_script_onCheckout()
    {
        ...
        if("wechatpay" ==$order->payment_method ){
            if (is_checkout_pay_page()&&!isset($_GET['pay_for_order'])) {
                wp_enqueue_script('Woo_WX_Loop', plugins_url( '/js/check_weichat_paid.js',__FILE__) , array('jquery'),null);
            }
        }
    ...
    function init_form_fields()
    {
        ...
        $this->form_fields = array(
           ...
           'WX_debug' => array(
                ...
                'default' => 'no',
                'description' => '请确认插件目录/logs 权限为777(可写)'
            )
        );
    ...
    public function admin_options()
    {
      ...
      ?>
		<h3>微信支付(免费版)</h3>
		<p>企业版本支持微信原生支付（H5公众号）、微信登录、微信红包促销、微信收货地址同步。<br/>若需要企业版本，请联系QQ:<a href="http://wpa.qq.com/msgrd?v=3&uin=6347007&site=qq&menu=yes" target="_blank">6347007</a>或移步<a href="http://www.wpweixin.net/" target="_blank">迅虎网络</a>查看更多内容</p>
